...
@section('profile-content')
    ...
    <div class="detailed-information-user">
        ...
        @else
            ...
            <div class="flex-column"><label>ИНН организации:</label><input name="inn_org" id="inn_org" type="text" value="{{$user->DetailedInformation->inn_org}}"></div>
            ...
            <div class="flex-column"><label>Бик банка:</label><input name="bik_bank" id="bik_bank" type="text" value="{{$user->DetailedInformation->bik_bank}}"></div>
            <div class="flex-column"><label>Расчетный счёт:</label><input name="payment_account_org" id="payment_account_org" type="text" value="{{$user->DetailedInformation->payment_account_org}}"></div>
