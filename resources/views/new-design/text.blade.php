...
{!! $aboutPage->text !!}
                ...
                <div data-anchor-relation="delivery" style="padding: 10px 30px;">
                    ...
                    <p>
                        ...
                        <p>Доставка за пределы МКАД 1500 + 50руб (за 1км.) (без выгрузки)</p>
                        ...
                        <p>Доставка заказа осуществляется на следующий день после готовности товара, но может изменится в зависимости от загруженности службы доставки или Ваших пожеланий.</p>
                        <p>После приготовления зеркала менеджер свяжется с Вами для уточнения о готовности принять заказ и сроках доставки.</p>
                        <p>Подтвердите о готовности принимать заказ до 12:00 и доставку сделаем в этот же день*.</p>
                        <p>*Данное условие только по Москве.</p>
                    </p>
                    <h2 class="text-center">Самовывоз</h2>
                    <p>
                        Мы свяжемся с вами, когда ваш заказ будет готов к получению, отправив уведомление о его готовности. Пожалуйста, обратите внимание, что мы гарантируем хранение вашего заказа в течение 14 дней.
                    </p>
                    <p>
                        <p>Адрес для самовывоза,  МО г. Мытищи,  микрорайон Пироговский , Фабричная ул., 1, , (подъезд 3)</p>
                        <p>Самовывоз возможен с ПН по ПТ 10:00 до 18:00</p>
                    </p>
                ...
                <div data-anchor-relation="payment" style="padding: 10px 30px;">
                    ...
                    <p>
                        <p>Обращаем Ваше внимание, что заказ запускаются в работу после предоплаты 50%. Все заказы по России отправляются только после предоплаты 100%.</p>
                        <p>После оплаты вы получите электронный чек (подтверждающий платёжный документ) — по электронной почте или СМС.</p>
                        <p>Так же предоставляем Безналичный расчет для юридических лиц.</p>
                    </p>
