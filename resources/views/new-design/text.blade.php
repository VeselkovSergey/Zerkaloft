...
{!! $aboutPage->text !!}
                ...
                <div data-anchor-relation="payment" style="padding: 10px 30px;">
                    ...
                    <p>
                        Обращаем Ваше внимание, что заказ запускаются в работу после предоплаты 50%. Все заказы по России отправляются только после предоплаты 100%.
                        После оплаты вы получите электронный чек (подтверждающий платёжный документ) — по электронной почте или СМС.
                        Так же предоставляем Безналичный расчет для юридических лиц.
                    </p>
