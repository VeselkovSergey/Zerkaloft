...
<div style="min-height: 100vh;">
    <div style="max-width: 1440px; min-height: 100vh; margin: auto;">
        ...
        <div class="show-adaptive">
            <div class="flex-column-center" style="position: fixed; right: 0; bottom: 70px;">
                <div class="mb-5">
                ...
                <div class="mb-5">
                    <a class="mx-10 whatsapp" href="https://api.whatsapp.com/send/?phone={}">
                        <img class="mx-10" width="26" src="http://victoria.local/icon/whatsapp.svg" alt="">
                    </a>
                </div>
                <div class="mb-5">
                    <a class="mx-10 telegram" href="https://t.me/{}">
                        <img class="mx-10" width="24" src="http://victoria.local/icon/telegram.svg" alt="">
                    </a>
                </div>
            </div>            <div class="mob-menu" style="position: fixed; bottom: 0; height: 60px; width: 100vw;">
