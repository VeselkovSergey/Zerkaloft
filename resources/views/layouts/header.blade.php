...
<div class="flex-center search-button-small-screen-container" style="width: 40%">
    <div  class="border-radius-5" style="border: 1px solid #2e3192; width: 100%; padding: 3px 0 3px 3px">
