<div style="/*height: 100%;*/ display: flex; /*margin: 0 20%;*/">
    ...
    <div style="margin: auto; /*width: 100%;*/" class="search-container-header">
        <div style="position: relative; /*top: 10px;*/">
            <div style="position: absolute; top: 11px; left: 10px; color: grey;">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                    <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
                </svg>
            </div>
            <input class="main-search-input" style="width: 100%; border: 2px solid #2e3192; padding: 10px; border-radius: 5px; text-indent: 30px;" type="text" placeholder="Поиск" value="">
            <div class="delete-value-search-input hide-el" style="position: absolute; top: 9px; right: 10px; cursor: pointer; color: grey;">
            ...
            <div class="fast-menu" style="display: flex; justify-content: center;">
                <a href="#">Быстрое оформление</a>
                <a href="#">Онлайн заказ</a>
                <a href="#">Индивидульный заказ</a>
        ...
        <div class="button-basket" style="display: flex; flex-wrap: wrap; justify-content: center; align-items: center; padding: 0 16px; text-align: center; cursor: pointer;">
            <a href="{{route('basket-page')}}" style="text-decoration: unset; color: unset;">
                ...
                <div style="width: 100%; position: relative;">
                    ...
                    <div class="count-item-in-bag hide-el" style="color: black; position: absolute;background-color: #ec407a;border-radius: 100px;top: -10px;padding: 5px;right: 0px; min-width: 26px;">
                        0
                    </div>
                </div>
                <div style="width: 100%; text-align: center; font-size: 14px;">
